...
class TestSetupLogging:
    ...
    @patch('os.makedirs')
    def test_setup_logging_creates_directories(self, mock_makedirs, mock_dict_config):
    ...
    @patch('logging.config.dictConfig')
    @patch('os.makedirs')
    def test_setup_logging_logs_startup_message(self, mock_makedirs, mock_dict_config, mock_get_logger):
        ...
        mock_logger.info.assert_called_with("Logging configuration initialized")
